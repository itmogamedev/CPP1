...
void looserWindowPrint(){
    // Create window
    sf::RenderWindow looserWindow(sf::VideoMode(800,600,60), "Dino Wars",sf::Style::Resize);
    ...
    startText.setString( "You are loooooooooooser!!!" );
    ...
    if ( !grave1.loadFromFile( resourcePath() + "grave2.png" ) )
        std::cout << "Can't find the image" << std::endl;
    ...
    if ( !grave2.loadFromFile( resourcePath() + "grave2.png" ) )
        std::cout << "Can't find the image" << std::endl;
    ...
    if ( !grave3.loadFromFile( resourcePath() + "grave2.png" ) )
        std::cout << "Can't find the image" << std::endl;
