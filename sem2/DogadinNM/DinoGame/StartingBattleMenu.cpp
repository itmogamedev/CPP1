        ...
        while (battleWindow.pollEvent(Event)) {
            ...
            switch (Event.type) {
                case sf::Event::MouseMoved:
                {
                    ...
                    //if for KIRA button
                    if ( buttonKiraPickText.getGlobalBounds().contains( mousePosF ) && buttonKiraPickText.getString() == "PICK")
                    {
                    ...
                    //if for COLE button
                    if ( buttonColePickText.getGlobalBounds().contains( mousePosF ) && buttonColePickText.getString() == "PICK")
                    {
