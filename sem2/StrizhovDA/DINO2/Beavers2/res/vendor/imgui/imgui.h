...
namespace ImGui
{
    ...
    IMGUI_API bool          Combo(const char* label, int* current_item, const char* const all_items[], int items_count, int popup_max_height_in_items = -1);
    ...
    IMGUI_API bool          ListBox(const char* label, int* current_item, const char* const all_items[], int items_count, int height_in_items = -1);
