...
public:
	sf::Sprite* sprite;
	const sf::Texture* openmouthtext;
	const sf::Texture* closemouthtext;
	Pet(int _speedGrowth,
		int _full,
		int _hydr,
		int _clean,
		sf::Sprite* _sprite,
		sf::Texture* _openmouthtext,
		sf::Texture* _closemouthtext
	) : size{ 20 },
		...
		clean{ _clean },
		sprite{_sprite},
		openmouthtext{ _openmouthtext },
		closemouthtext{ _closemouthtext },
		maxSize {100},
		maxFull {1000},
		maxHydr {1000},
		maxClean {1000}
