						...
						if (go) {
							...
							if (sum > 10) {
								for (int i = 0; i < dinochoose.size(); i++) {
									if (dinochoose.at(i) == 3) {
										DinoStr dinostr(dinos[0]->str, dinos[0]->dex, dinos[0]->inte);
										DinoDex dinodex(dinos[0]->str, dinos[0]->dex, dinos[0]->inte);
										DinoInt dinoint(dinos[0]->str, dinos[0]->dex, dinos[0]->inte);
										...
										DinoStr dinostro(temp[1], temp[2], temp[3]);
										DinoDex dinodexo(temp[1], temp[2], temp[3]);
										DinoInt dinointo(temp[1], temp[2], temp[3]);
