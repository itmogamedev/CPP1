...
void profileWindowPrint(){
    ...
    if ( !dinoKiraTexture.loadFromFile( resourcePath() + "dinoAssets/Kuro/idle.png" ) )
        std::cout << "Can't find the image" << std::endl;
    ...
    sf::Text kiraTextName("Kuro ", font);
    ...
    if ( !dinoColeTexture.loadFromFile( resourcePath() + "dinoAssets/Loki/idle.png" ) )
        std::cout << "Can't find the image" << std::endl;
    ...
    sf::Text coleTextName("Loki ", font);
    ...
    namespaceText.setFillColor(sf::Color::Black);
    namespaceText.setStyle(sf::Text::Regular);
    ...
    balanceText.setStyle(sf::Text::Regular);
