...
void menuWindowPrint(){
    ...
    // Create window
    sf::RenderWindow window(sf::VideoMode(800,600,60), "Dino Battle",sf::Style::Resize);
        ...
        while (window.pollEvent(Event))
        {
            switch ( Event.type )
            {
                ...
                case sf::Event::MouseMoved:
                {
                    ...
                    {
                        exitButtonImage.setColor( sf::Color( 255, 255, 255, 150 ) );
                    }
                    else
                    {
                    ...
                    {
                        startText.setFillColor(sf::Color(0, 0, 0, 150));
                    }
                    else
                    {
                        startText.setFillColor(sf::Color::Black);
                    ...
                    {
                        profileText.setFillColor(sf::Color(0, 0, 0, 150));
                    }
                    else
                    {
                        profileText.setFillColor(sf::Color::Black);
                    ...
                    {
                        shopText.setFillColor(sf::Color(0, 0, 0, 150));
                    }
                    else
                    {
                        shopText.setFillColor(sf::Color::Black);
                    ...
                    {
                        battleText.setFillColor(sf::Color(0, 0, 0, 150));
                    }
                    else
                    {
                        battleText.setFillColor(sf::Color::Black);
