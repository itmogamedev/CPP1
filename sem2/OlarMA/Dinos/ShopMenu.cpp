...
void shopWindowPrint() {
    ...
    sf::RenderWindow shopWindow(sf::VideoMode(800, 600), "DinoBattle", sf::Style::Resize);
    ...
    sf::Text dinoKiraCharacteristics(
    ...
    sf::Text dinoColeCharacteristics(
    ...
    sf::Text dinoMonoCharacteristics(
        ...
        while (shopWindow.pollEvent(Event)) {
            switch (Event.type) {
                case sf::Event::MouseMoved: {
                    ...
                    if (buttonKiraBuyText.getGlobalBounds().contains(mousePosF) &&
                        buttonKiraBuyText.getString() == "BUY" && outStr != "0") {
                        buttonKiraBuyText.setFillColor(sf::Color::Red);
                    } else {
                        buttonKiraBuyText.setFillColor(sf::Color::Black);
                    }
                    ...
                    if (buttonColeBuyText.getGlobalBounds().contains(mousePosF) &&
                        buttonColeBuyText.getString() == "BUY" && outStr != "0") {
                        buttonColeBuyText.setFillColor(sf::Color::Red);
                    } else {
                        buttonColeBuyText.setFillColor(sf::Color::Black);
                    }
                    ...
                    if (buttonMonoBuyText.getGlobalBounds().contains(mousePosF) &&
                        buttonMonoBuyText.getString() == "BUY" && outStr != "0") {
                        buttonMonoBuyText.setFillColor(sf::Color::Red);
                    } else {
                        buttonMonoBuyText.setFillColor(sf::Color::Black);
                    }
                ...
                case sf::Event::MouseButtonPressed: {
                    ...
                    if (buttonKiraBuyText.getGlobalBounds().contains(mousePosF) && outStr != "0" &&
                        buttonKiraBuyText.getString() == "BUY") {
                        updateBalance(outStr, Kira().name);
                        buttonKiraBuyText.setString("Purchased");
                        sleep_until(system_clock::now() + seconds(2));

                    }
                    if (buttonColeBuyText.getGlobalBounds().contains(mousePosF) && outStr != "0" &&
                        buttonColeBuyText.getString() == "BUY") {
                        updateBalance(outStr, Cole().name);
                        buttonColeBuyText.setString("Purchased");
                        sleep_until(system_clock::now() + seconds(2));

                    }
                    if (buttonMonoBuyText.getGlobalBounds().contains(mousePosF) && outStr != "0" &&
                        buttonMonoBuyText.getString() == "BUY") {
