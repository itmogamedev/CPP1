...
void profileWindowPrint() {
    sf::RenderWindow profileWindow(sf::VideoMode(800, 600), "DinoBattle", sf::Style::Resize);
    ...
    if (!backgroundTextureForDinos.loadFromFile("C:/Users/mikhail/CLionProjects/Dinosaur/dinoAssets/dinosBackground.jpg"))
        std::cout << "Can't find the image" << std::endl;
    ...
    sf::Text kiraTextName("JKNLFB ", font);
    ...
    sf::Text coleTextName("JFPBSPI ", font);
    ...
    sf::Text monoTextName("FPIBPD ", font);
